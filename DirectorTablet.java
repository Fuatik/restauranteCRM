...
public class DirectorTablet {
    ...
    public void printCookWorkloading() {
        ...
        List<String> list = new ArrayList<>(cookWorkloadingMap.keySet());
        Collections.sort(list);
    ...
    public void printActiveVideoSet() {
        List<Advertisement> videos = StatisticAdvertisementManager.getInstance().getVideos(true);
        videos.sort(new Comparator<Advertisement>() {
            @Override
    ...
    public void printArchivedVideoSet() {
        List<Advertisement> videos = StatisticAdvertisementManager.getInstance().getVideos(false);
        videos.sort(new Comparator<Advertisement>() {
            @Override
            public int compare(Advertisement o1, Advertisement o2) {
                return o1.getName().compareToIgnoreCase(o2.getName());
